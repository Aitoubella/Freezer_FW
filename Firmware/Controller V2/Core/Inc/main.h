...
#define RTD1_IN7_Pin GPIO_PIN_2
#define RTD1_IN7_GPIO_Port GPIOA
#define RTD2_IN8_Pin GPIO_PIN_3
#define RTD2_IN8_GPIO_Port GPIOA
...
#define USBPWREN_Pin GPIO_PIN_8
#define USBPWREN_GPIO_Port GPIOA

...
void ili9341_bklight_on(void)
{
	HAL_GPIO_WritePin(TFT_BKLIGHT_GPIO_Port, TFT_BKLIGHT_Pin, GPIO_PIN_SET);//Turn on black light
}

void ili9341_bklight_off(void)
{
	HAL_GPIO_WritePin(TFT_BKLIGHT_GPIO_Port, TFT_BKLIGHT_Pin, GPIO_PIN_RESET);//Turn on black light
}

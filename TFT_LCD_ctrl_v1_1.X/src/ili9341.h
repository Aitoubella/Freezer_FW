...
#define LCD_DC_LAT      LATAbits.LATA1
#define LCD_RST_LAT      LATAbits.LATA9
#define LCD_CS_LAT       LATFbits.LATF12

#define LCD_DC_TRIS    TRISAbits.TRISA1
#define LCD_RST_TRIS    TRISAbits.TRISA9
#define LCD_CS_TRIS     TRISFbits.TRISF12

#define ILI9341_SPI_PLIB
#define ILI9341_SPI_SPEED_UP
